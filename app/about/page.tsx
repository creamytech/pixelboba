  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:title" content="pixel boba — about us" />
        <meta
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl md:text-2xl text-gray-600 leading-relaxed lowercase max-w-3xl mx-auto">
                  pixel boba is a small but mighty studio mixing code and creativity. we build
                  custom websites that feel as fresh as your favorite drink—smooth, fun, and
                  designed to pop.
                </p>
              </div>
            </div>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed lowercase">
                      <strong className="text-ink">fewer hoops to jump through</strong>—clear
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed lowercase">
                      <strong className="text-ink">built to last</strong>—fast, accessible, and
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed lowercase">
                      <strong className="text-ink">our custom client dashboard</strong> keeps
                      everything in one place—progress, messages, and payments.
                    </p>
                  </div>
                </div>
              </div>
