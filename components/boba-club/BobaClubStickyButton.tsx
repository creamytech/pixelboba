  ...
  return (
    ...
    >
      <Button
        asChild
        size="lg"
        className="group bg-gradient-to-r from-taro to-deep-taro hover:from-deep-taro hover:to-taro text-white px-6 py-6 rounded-full shadow-2xl hover:shadow-taro/50 transition-all duration-300 relative overflow-hidden"
      >
        <Link href="/start" className="inline-flex items-center gap-2">
          ...
          {/* Pulse ring */}
          <motion.div
            className="absolute inset-0 rounded-full border-4 border-taro"
            animate={{
              scale: [1, 1.5, 1.5],
              opacity: [0.5, 0, 0],
            }}
